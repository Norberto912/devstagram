...
<div class="md:flex md:justify-center md:gap-10 md:items-center ">
    ...
    <div class="md:w-4/12 bg-white p-6 rounded-r-lg shadow-xl md:gap-4">
        <form action="{{route('register')}}" method="POST" novalidate>
            ...
            <div class="mb-5">
             ...
             <input type="submit" values="Crear Cuenta" class="bg-sky-600 hover::bg-sky-700 transition-colors cursor-pointer uppercase font-bold w-full p-3 text-white rounded-lg" />             
