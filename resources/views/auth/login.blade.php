    ...
    <div class="md:w-4/12 bg-white p-6 rounded-r-lg shadow-xl md:gap-4">
        <form method="POST" action="{{route('login')}}" novalidate>
            ...
            @endif
             ...
             <input type="submit" values="Iniciar Sesion" class="bg-sky-600 hover::bg-sky-700 transition-colors cursor-pointer uppercase font-bold w-full p-3 text-white rounded-lg" />             
