...
<div class="flex justify-center">
    <div class="w-full md:w-8/12 lg:w-8/12 flex flex-col items-center md:flex-row ">
        ...
        <div class="md:w-8/12 lg-w-6/12 px-5 flex flex-col items-center md:justify-center md:items py-10 md:py-10" >           
            ...
            <p class="text-gray-800 text-sm mb-3 font-bold">
                ...
                <span class="font-normal">@choice('Segidor|Seguidores',$user->followers->count())</span>
            </p>
            <p class="text-gray-800 text-sm mb-3 font-bold">
                {{$user->followers->count()}}
